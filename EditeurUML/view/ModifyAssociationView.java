 ...
 * @author aur
 */
public class ModifyAssociationView extends javax.swing.JFrame {
     ...
     */
    public ModifyAssociationView(ProjectUML model, int type, int index) {
    	this.type=type;
    	this.index=index;
    	this.model=model;
        initComponents();
    ...
    private void initComponents() {
        ...
        class1ComboBox.setSelectedItem(model.getAssociationList().get(index).getFirstObject().getName());
        ...
        nameTextField.setText(model.getAssociationList().get(index).getName());
        ...
        deleteButton.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				model.getAssociationList().remove(index);
				dispose();
			}
		});
