 ...
 * @author aur
 */
public class ModifyMethodObjectView2 extends javax.swing.JFrame {
    ...
    public ModifyMethodObjectView2() {
        initComponents();
    }
    ...
    public ModifyMethodObjectView2(ProjectUML model, int index, int method){
    	this.model=model;
    	this.index=index;
    	this.method=method;
    	initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyMethodObjectView2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModifyMethodObjectView2().setVisible(true);
            }
        });
    }
